        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 4:
                //this line of code is not working.  Cannot see discription of helpTicketContent
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 5:
                ...
                if (this.filesToUpload && this.filesToUpload.length > 0) this.helpTickets.uploadFile(this.filesToUpload, serverResponse.contentID); // await this.helpTickets.saveHelpTicket(helpTicket);
...
define('resources/data/help-ticket-object',["exports", "aurelia-framework", "./data-services"], function (_exports, _aureliaFramework, _dataServices) {
  ...
  function () {
    ...
    function () {
      ...
      return function getHelpTicketsContents(_x4) {
